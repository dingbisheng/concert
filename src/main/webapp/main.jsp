...
<head>
    ...
    <meta name="create-time" content="2018-04-11 14:31:30" />
    <meta property="qc:admins" content="1733241067641511636" />
    <meta name="keywords" content="演唱会,音乐会,话剧,体育比赛,门票,订票,购票,演出,先付先抢,在线选座,明星演唱会,在线订票,大麦网"/>
    <meta name="description" content="大麦网-全球华语排名领先票务网站、官方购票渠道！为您全方位提供演唱会、音乐会、话剧、体育比赛等上万种门票在线订购服务。安全快捷，让您享受优质的购票体验！"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/concert/css/public-min_1.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/concert/css/style-min.css"/>
    <script type="text/javascript" src="<%=basePath%>/concert/js/a7a9dd1d20624378ae2bc25de5570b6e.js"></script>
</head>
...
<div class="wrapper">
    ...
    <div class="header-w">
        ...
        <div class="dm-citys">
            <div class="dm-citys-change">
                ...
                <div class="ri-con">
        <span class="ri-t">
            当前全国共有<i>4483</i>场演出（比赛），城市后数字代表演出场次
        </span>
            ...
            <div class="sort-list">
                <ul>
                    ...
                    <c:forEach items="${assortmentDTOList}" var="assortment" varStatus="status">
                        <li>
                            <a href="/assortment/queryMessage?sortId=${assortment.sortId}" target="_blank" class="sort-list-${status.count} lnk" id="home_fldh_00${status.count}" data-categoryId="${status.count}"><span>${assortment.sortName}</span></a>
                            <div class="sort-layer">
                                <a class="ri-close" href="#">关闭</a>
                                <dl class="layer-top">
                                    <dt>${assortment.sortName}</dt>
                                    <dd>
                                        <span>&gt;</span>
                                        <c:forEach items="${assortment.subclassDTOList}" var="SubclassDTO">
                                            <a href="/assortment/queryMessage?sortId=${assortment.sortId}&subId=${SubclassDTO.subId}" target="_blank" id="home_fldh_tan_ych_wenzi_001">${SubclassDTO.subName}</a><i>|</i>
                                        </c:forEach>
                                    </dd>
                                </dl>
                                <div class="layer-info">
                                    ...
                                    <ul class="showlist">
                                        <%--${sortDetailsListHashMap}--%>
                                        <c:forEach items="${sortDetailsListHashMap.get(assortment.sortId)}" var="sortDetails" varStatus="status">
                                            <li class="img">
                                                <a id="city_recom${status.count}" href="" target="_blank"
                                                               title="${sortDetails.name}" class="img" data-spm-anchor-id="a2o6e.home.0.0">
                                                    <img src="<%=basePath%>/concert/img/${sortDetails.img}" width="145" height="193" data-spm-anchor-id="a2o6e.home.0.i1.591b48d3Fdv7vq">
                                                </a>
                                                <a id="city_recom${status.count}" href="" target="_blank" title="${sortDetails.name}"
                                                   class="title">${sortDetails.name}
                                                </a>
                                                <span class="price">票价：<strong><i class="yen">¥</i>${sortDetails.price}起</strong></span>
                                            </li>
                                        </c:forEach>
        ...
        <div class="slide-main">
            <div class="mn">
                <ul class="lst" id="topadpic">
                    <li class="itm"  data-src="https://pimg.dmcdn.cn/perform/damai/home/201804/20180410190925428.jpg" data-color=""><a class="lnk" href="https://piao.damai.cn/141331.html?spm=a2o6e.home_bj.0.0.22db3d1dxzojK4" target="_blank" title="北京人和VS贵州恒丰" id="home_lunbo_001"><img src="<%=basePath%>/concert/picture/20180410190925428.jpg" /></a></li>
                    <li class="itm"  style="display:none;"  data-src="https://pimg.dmcdn.cn/perform/damai/home/201804/20180408164018317.jpg" data-color=""><a class="lnk" href="https://piao.damai.cn/144747.html" target="_blank" title="长春亚泰VS河南建业" id="home_lunbo_002"><img src="<%=basePath%>/concert/picture/20180408164018317.jpg" /></a></li>
                    <li class="itm"  style="display:none;"  data-src="https://pimg.dmcdn.cn/perform/damai/home/201803/20180312155100554.jpg" data-color=""><a class="lnk" href="https://p.damai.cn/wow/special/act/zhilehui2018" target="_blank" title="至乐汇全国巡演" id="home_lunbo_003"><img src="<%=basePath%>/concert/picture/20180312155100554.jpg" /></a></li>
                    <li class="itm"  style="display:none;"  data-src="https://pimg.dmcdn.cn/perform/damai/home/201802/20180205110717232.jpg" data-color=""><a class="lnk" href="https://x.damai.cn/markets/pc/2018qiaohu?spm=a2o6e.kids.0.0.6ad71644Ieqbo2&wh_ttid=pc" target="_blank" title="快乐农场大冒险" id="home_lunbo_004"><img src="<%=basePath%>/concert/picture/20180205110717232.jpg" /></a></li>
                </ul>
            </div>
            <div class="sd">        <div class="box">
                <input type="hidden" id="topadcount" value="4"/>
                <ul class="lst" id="topadtitle">
                    <li class="itm"><a href="javascript:;" title="北京人和VS贵州恒丰">
                        <span class="num">01.</span>
                        <span class="txt">北京人和VS贵州恒丰</span></a>
                    </li>
                    <li class="itm"><a href="javascript:;" title="长春亚泰VS河南建业">
                        <span class="num">02.</span>
                        <span class="txt">长春亚泰VS河南建业</span></a>
                    </li>
    ...
    <div class="index-con">
        ...
        <div class="hotlike">
            <div class="hd">
                <div class="tab">
                    <a class='itm' id='tabCainilike' href='javascript:();'><span class='txt'>猜您喜欢</span><span class='ico'></span></a>
                    <a class="itm z-sel" id="everydaytuijian" href="javascript:;">今日推荐</a>
                ...
                <div class="box">
                    ...
                    <ul class="poster z-act" id="showlike">
                        <li class="show-poster-1">
                            <a href="https://piao.damai.cn/141083.html" target="_blank" class="img" id="home_jrtj_001_141083">
                                <img original="https://pimg.dmcdn.cn/perform/project/1410/141083_n.jpg?_t=1521795247614" width="150" height="200" title="2018年“乐谷·北京超级草莓音乐节”" />
                            </a>
                            <a href="https://piao.damai.cn/141083.html" target="_blank" title="2018年“乐谷·北京超级草莓音乐节”" class="title" id="home_jrtj_001_141083">2018年“乐谷·北京超级草莓音乐节”</a>
					<span class="price">
						票价：<strong>
                        <i class="yen">&yen;</i>320
                    </strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">中国乐谷草地音乐公园（北京渔阳国际滑雪场）</p>
                                <p class="time">2018.04.29-05.01</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="https://piao.damai.cn/146524.html" target="_blank" class="img" id="home_jrtj_002_146524">
                                <img original="https://pimg.dmcdn.cn/perform/project/1465/146524_n.jpg?_t=1522048260966" width="150" height="200" title="MaiLive 多媒体3D舞台剧盗墓笔记番外篇《新月饭店》" />
                            </a>
                            <a href="https://piao.damai.cn/146524.html" target="_blank" title="MaiLive 多媒体3D舞台剧盗墓笔记番外篇《新月饭店》" class="title" id="home_jrtj_002_146524">MaiLive 多媒体3D舞台剧盗墓笔记番外篇《新月饭店》</a>
					<span class="price">
						票价：<strong>
                        <i class="yen">&yen;</i>180
                    </strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">锦城艺术宫</p>
                                <p class="time">2018.05.05-05.06</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="https://piao.damai.cn/142612.html" target="_blank" class="img" id="home_jrtj_003_142612">
                            ...
                            <a href="https://piao.damai.cn/142612.html" target="_blank" title="赖声川执导，曹禺作品  话剧《北京人》" class="title" id="home_jrtj_003_142612">赖声川执导，曹禺作品  话剧《北京人》</a>
					<span class="price">
						票价：<strong>
                        ...
                        <li class="show-poster-1">
                            <a href="https://piao.damai.cn/135693.html" target="_blank" class="img" id="home_jrtj_004_135693">
                                <img original="https://pimg.dmcdn.cn/perform/project/1356/135693_n.jpg" width="150" height="200" title="世界经典原版音乐剧《猫》Cats 北京站" />
                            </a>
                            <a href="https://piao.damai.cn/135693.html" target="_blank" title="世界经典原版音乐剧《猫》Cats 北京站" class="title" id="home_jrtj_004_135693">世界经典原版音乐剧《猫》Cats 北京站</a>
					<span class="price">
						票价：<strong>
                        ...
                        <li class="show-poster-1">
                            <a href="https://piao.damai.cn/119884.html" target="_blank" class="img" id="home_jrtj_005_119884">
                            ...
                            <a href="https://piao.damai.cn/119884.html" target="_blank" title="五月天 LIFE [ 人生无限公司 ] 世界巡回演唱会-沈阳站  2018 MAYDAY LIFE TOUR" class="title" id="home_jrtj_005_119884">五月天 LIFE [ 人生无限公司 ] 世界巡回演唱会-沈阳站  2018 MAYDAY LIFE TOUR</a>
					<span class="price">
						票价：<strong>
                        ...
                        <li class="show-poster-1">
                            <a href="https://piao.damai.cn/137617.html" target="_blank" class="img" id="home_jrtj_006_137617">
                                <img original="https://pimg.dmcdn.cn/perform/project/1376/137617_n.jpg" width="150" height="200" title="北京刘老根大舞台" />
                            </a>
                            <a href="https://piao.damai.cn/137617.html" target="_blank" title="北京刘老根大舞台" class="title" id="home_jrtj_006_137617">北京刘老根大舞台</a>
					<span class="price">
						票价：<strong>
                        <i class="yen">&yen;</i>380
                    </strong>起					</span>
                    ...
                    <ul class="poster">
                        ...
                        <li class="show-poster-1">
                            <a href="//piao.damai.cn/148064.html" class="img" target="_blank" id="home_jjkp_001_148064">
                                <img src="<%=basePath%>/concert/picture/148064_n_171_214.jpg" width="145" height="193" title="央华精品戏剧展演《西贡》" />
                            </a>
                            <a href="//piao.damai.cn/148064.html" class="title" target="_blank" title="央华精品戏剧展演《西贡》" id="home_jjkp_001_148064">央华精品戏剧展演《西贡》</a>
					<span class="price">
						票价：<strong><i class="yen">&yen;</i>280</strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">保利剧院</p>
                                <p class="time">2018.06.23-06.24</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="//piao.damai.cn/148059.html" class="img" target="_blank" id="home_jjkp_002_148059">
                                <img src="<%=basePath%>/concert/picture/148059_n_171_214.jpg" width="145" height="193" title="Blue Note Beijing 神秘树顶(SECRET TREETOP) - 陈宣羽纽约五重奏" />
                            </a>
                            <a href="//piao.damai.cn/148059.html" class="title" target="_blank" title="Blue Note Beijing 神秘树顶(SECRET TREETOP) - 陈宣羽纽约五重奏" id="home_jjkp_002_148059">Blue Note Beijing 神秘树顶(SECRET TREETOP) - 陈宣羽纽约五重奏</a>
					<span class="price">
						票价：<strong><i class="yen">&yen;</i>120</strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">Blue Note Beijing</p>
                                <p class="time">2018.05.24  19:30</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="//piao.damai.cn/148041.html" class="img" target="_blank" id="home_jjkp_003_148041">
                                <img src="<%=basePath%>/concert/picture/148041_n_171_214.jpg" width="145" height="193" title="【天赐文化】安徒生经典童话木偶剧 《卖火柴的小女孩》" />
                            </a>
                            <a href="//piao.damai.cn/148041.html" class="title" target="_blank" title="【天赐文化】安徒生经典童话木偶剧 《卖火柴的小女孩》" id="home_jjkp_003_148041">【天赐文化】安徒生经典童话木偶剧 《卖火柴的小女孩》</a>
					<span class="price">
						票价：<strong><i class="yen">&yen;</i>60</strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">广州少年宫蓓蕾剧院</p>
                                <p class="time">2018.05.27</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="//piao.damai.cn/148035.html" class="img" target="_blank" id="home_jjkp_004_148035">
                                <img src="<%=basePath%>/concert/picture/148035_n_171_214.jpg" width="145" height="193" title="郭麒麟阎鹤祥相声专场2018全国巡演 天津站" />
                            </a>
                            <a href="//piao.damai.cn/148035.html" class="title" target="_blank" title="郭麒麟阎鹤祥相声专场2018全国巡演 天津站" id="home_jjkp_004_148035">郭麒麟阎鹤祥相声专场2018全国巡演 天津站</a>
					<span class="price">
						票价：<strong><i class="yen">&yen;</i>188</strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">天津大礼堂</p>
                                <p class="time">2018.07.28 19:30</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="//piao.damai.cn/147994.html" class="img" target="_blank" id="home_jjkp_005_147994">
                                <img src="<%=basePath%>/concert/picture/147994_n_171_214.jpg" width="145" height="193" title="2018深圳“一带一路”音乐季季后演出  迪玛希D-Dynasty世界巡回演唱会（深圳站）" />
                            </a>
                            <a href="//piao.damai.cn/147994.html" class="title" target="_blank" title="2018深圳“一带一路”音乐季季后演出  迪玛希D-Dynasty世界巡回演唱会（深圳站）" id="home_jjkp_005_147994">2018深圳“一带一路”音乐季季后演出  迪玛希D-Dynasty世界巡回演唱会（深圳站）</a>
					<span class="price">
						票价：<strong><i class="yen">&yen;</i>280</strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">深圳大运中心体育馆</p>
                                <p class="time">2018.05.19 19 ：30</p>
                            </div>
                        </li>
                        <li class="show-poster-1">
                            <a href="//piao.damai.cn/147984.html" class="img" target="_blank" id="home_jjkp_006_147984">
                                <img src="<%=basePath%>/concert/picture/147984_n_171_214.jpg" width="145" height="193" title="环球音乐之旅——加拿大奥雪来嘉三重奏音乐会" />
                            </a>
                            <a href="//piao.damai.cn/147984.html" class="title" target="_blank" title="环球音乐之旅——加拿大奥雪来嘉三重奏音乐会" id="home_jjkp_006_147984">环球音乐之旅——加拿大奥雪来嘉三重奏音乐会</a>
					<span class="price">
						票价：<strong><i class="yen">&yen;</i>80</strong>起					</span>
                            <div class="poster-single">
                                <p class="addr">特仑苏音乐厅</p>
    ...
    <div class="index-con">
        <a href="https://x.damai.cn/markets/special/fangzhapian?wh_ttid=pc" class="in-ad fl mr10" target="_blank" title="年底防诈骗" id="home_wzgg_001">
            <img original="https://pimg.dmcdn.cn/perform/damai/home/201712/20171208104150113.jpg" style="width:393px; height: 90px;" />
        </a>
        <a href="//i.damai.cn/" class="in-ad fl mr10" target="_blank" title="精彩专题" id="home_wzgg_002">
            <img original="https://pimg.dmcdn.cn/perform/damai/home/201701/20170106161125822.png" style="width:393px; height: 90px;" />
        </a>
        <a href="https://sale.damai.cn/act/dm_ypyz.html" class="in-ad fl " target="_blank" title="一票一证" id="home_wzgg_003">
            <img original="https://pimg.dmcdn.cn/perform/damai/home/201706/20170602154928362.png" style="width:393px; height: 90px;" />
        </a>
    </div>
    <div class="index-con">
        <div class="focus-stars">
            <ul class="stars-list">
                <li class="s1">
                    <img original="https://pimg.dmcdn.cn/perform/damai/home/201804/20180408171512798_238_362.jpg" width="238" height="362"/>
                    <div class="layer-info">
                        <p class="title" title="草莓音乐节">草莓音乐节</p>            <div class="infos-box">
                        <div class="infos">
                            <a href="//piao.damai.cn/141083.html" target="_blank" id="home_xunyan_001_141083">北京站</a>
                            <a href="//piao.damai.cn/147337.html" target="_blank" id="home_xunyan_002_147337">西安站</a>
                            <a href="//piao.damai.cn/147209.html" target="_blank" id="home_xunyan_003_147209">长沙站</a>
                            <a href="//piao.damai.cn/145382.html" target="_blank" id="home_xunyan_004_145382">成都站</a>
                            <a href="//piao.damai.cn/145486.html" target="_blank" id="home_xunyan_005_145486">杭州站</a>
                            <a href="//piao.damai.cn/140703.html" target="_blank" id="home_xunyan_006_140703">上海站</a>
                        </div>
                        <a href="https://piao.damai.cn/141083.html?spm=a2o6e.search.0.0.4b274bcbZ0QY1c" class="ite" target="_blank">专题</a>
                    </div>
                    </div>
                </li>
                <li class="s2">
                    ...
                    <div class="layer-info02">
                        <div class="infos-box">
                            <div class="infos">
                                <a href="//piao.damai.cn/138043.html" target="_blank" id="home_xunyan_001_138043">沈阳站</a>
                            </div>
                ...
                <li class="s4">
                    ...
                    <div class="layer-info02">
                        <div class="infos-box">
                            <div class="infos">
                                <a href="//piao.damai.cn/139515.html" target="_blank" id="home_xunyan_001_139515">太原站</a>
                            </div>
                ...
                <li class="s6">
                    ...
                    <div class="layer-info02">
                        <div class="infos-box">
                            <div class="infos">
                                <a href="//piao.damai.cn/141343.html" target="_blank" id="home_xunyan_001_141343">杭州站</a>
                            </div>
                ...
                <li class="s7">
                    <img original="https://pimg.dmcdn.cn/perform/damai/home/201804/20180408171732685_238_238.jpg" width="238" height="238"/>
                    <div class="layer-info02">
                        <div class="infos-box">
                            <div class="infos">
                                <a href="//piao.damai.cn/142378.html" target="_blank" id="home_xunyan_001_142378">温州站</a>
                                <a href="//piao.damai.cn/144288.html" target="_blank" id="home_xunyan_002_144288">太原站</a>
                                <a href="//piao.damai.cn/144918.html" target="_blank" id="home_xunyan_003_144918">惠州站</a>
                                <a href="//piao.damai.cn/141427.html" target="_blank" id="home_xunyan_004_141427">深圳站</a>
                                <a href="//piao.damai.cn/144600.html" target="_blank" id="home_xunyan_005_144600">东莞站</a>
                                <a href="//piao.damai.cn/140979.html" target="_blank" id="home_xunyan_006_140979">绍兴站</a>
                                <a href="//piao.damai.cn/141636.html" target="_blank" id="home_xunyan_007_141636">泰州站</a>
                            </div>
                            <a href="https://piao.damai.cn/141427.html?spm=a2o6e.search.0.0.709d17d1hkHpGe" class="ite" target="_blank">专题</a>
                        </div>
                    </div>
                </li>
                <li class="s8">
                ...
                <li class="s9">
                    <img original="https://pimg.dmcdn.cn/perform/damai/home/201803/20180327150330320_114_114.jpg" width="114" height="114"/>
                    <div class="layer-info02">
                        <div class="infos-box">
                            <div class="infos">
                            </div>
                            <a href="https://piao.damai.cn/144345.html?spm=a2o6e.search.0.0.7e3d15b0F80fwZ" class="ite" target="_blank">专题</a>
                        </div>
                    </div>
                </li>
                <li class="s10">
    ...
    <div class="index-con rec" style="display:none;" id="indexCity">
        <div class="city">
            <div class="txt">
                <p class="fr" id="insiteName"></p>
                <div class="txt-fl"><strong class="insiteName">上海</strong><span class="pd">猜你想看<span class="insiteName">上海</span>周边的演出及赛事</span>
                    <div class="side-citys">
                        <a class="tit" href="javascript:;">[其他城市]</a>
                        <div class="side-citys-con">
                            <div class="hd">
                                <a class="ri-close" href="#">关闭</a>
                            </div>
                            <div class="side-citys-info">
                                <ul>
                                    <li><a href="/bj/" target="_blank">北京</a></li>
                                    <li><a href="/gz/" target="_blank">广州</a></li>
                                    <li><a href="/sh/" target="_blank">上海</a></li>
                                    <li><a href="/nj/" target="_blank">南京</a></li>
                                    <li><a href="/hk/" target="_blank">港澳</a></li>
                                    <li><a href="/taizhou/" target="_blank">台州</a></li>
                                    <li><a href="/xa/" target="_blank">西安</a></li>
                                    <li><a href="/hz/" target="_blank">杭州</a></li>
                                    <li><a href="/cd/" target="_blank">成都</a></li>
                                    <li><a href="/cq/" target="_blank">重庆</a></li>
                                    <li><a href="/ningbo/" target="_blank">宁波</a></li>
                                    <li><a href="/wuxi/" target="_blank">无锡</a></li>
                                    <li><a href="/sz/" target="_blank">深圳</a></li>
                                    <li><a href="/wuhan/" target="_blank">武汉</a></li>
                                    <li><a href="/jn/" target="_blank">济南</a></li>
                                    <li><a href="/km/" target="_blank">昆明</a></li>
                                    <li><a href="/nn/" target="_blank">南宁</a></li>
                                    <li><a href="/foshan/" target="_blank">佛山</a></li>
                                    <li><a href="/ty/" target="_blank">太原</a></li>
                                    <li><a href="/hrb/" target="_blank">哈尔滨</a></li>
                                    <li><a href="/nanchang/" target="_blank">南昌</a></li>
                                    <li><a href="/wenzhou/" target="_blank">温州</a></li>
                                    <li><a href="/cs/" target="_blank">长沙</a></li>
                                    <li><a href="/fuzhou/" target="_blank">福州</a></li>
                                    <li><a href="/tj/" target="_blank">天津</a></li>
                                    <li><a href="/suz/" target="_blank">苏州</a></li>
                                    <li><a href="/zhengzhou/" target="_blank">郑州</a></li>
                                    <li><a href="/dg/" target="_blank">东莞</a></li>
                                    <li><a href="/gy/" target="_blank">贵阳</a></li>
                                    <li><a href="/sjz/" target="_blank">石家庄</a></li>
                                    <li><a href="/xiamen/" target="_blank">厦门</a></li>
                                    <li><a href="/lanzhou/" target="_blank">兰州</a></li>
                                    <li><a href="/sy/" target="_blank">沈阳</a></li>
                                    <li><a href="/changzhou/" target="_blank">常州</a></li>
                                    <li><a href="/nantong/" target="_blank">南通</a></li>
                                    <li><a href="/neimeng/" target="_blank">内蒙古</a></li>
                                    <li><a href="/yantai/" target="_blank">烟台</a></li>
                                    <li><a href="/changchun/" target="_blank">长春</a></li>
                                    <li><a href="/qd/" target="_blank">青岛</a></li>
                                    <li><a href="/haikou/" target="_blank">海南</a></li>
                                    <li><a href="/wulumuqi/" target="_blank">乌鲁木齐</a></li>
                                    <li><a href="/zhuhai/" target="_blank">珠海</a></li>
                                    <li><a href="/yangzhou/" target="_blank">扬州</a></li>
                                    <li><a href="/dl/" target="_blank">大连</a></li>
                                    ...
                                    <li><a href="/zs/" target="_blank">中山</a></li>
                                    <li><a href="/huizhou/" target="_blank">惠州</a></li>
                                    <li><a href="/hf/" target="_blank">合肥</a></li>
                                    <li><a href="/jx/" target="_blank">嘉兴</a></li>
                                    <li><a href="/lz/" target="_blank">柳州</a></li>
                                    <li><a href="/tangshan/" target="_blank">唐山</a></li>
                                    <li><a href="/ych/" target="_blank">银川</a></li>
                                    <li><a href="/ls/" target="_blank">拉萨</a></li>
                                    <li><a href="/gl/" target="_blank">桂林</a></li>
                                    <li><a href="/xuzhou/" target="_blank">徐州</a></li>
                                    <li><a href="/hwz/" target="_blank">海外</a></li>
                                    <li><a href="/xn/" target="_blank">西宁</a></li>
                                    <li><a href="/sx/" target="_blank">绍兴</a></li>
                                    <li><a href="/jiangmen/" target="_blank">江门</a></li>
                                    <li><a href="/jinhua/" target="_blank">金华</a></li>
                                    <li><a href="/beihai/" target="_blank">北海</a></li>
                                    <li><a href="/tz/" target="_blank">泰州</a></li>
            ...
            <div class="hot">
                <dl class="word">
                    <dt>城市热词<span class="arrow"></span></dt>
                    <dd id="sitehotTxt"></dd>
                </dl>
                <dl class="venue">
                    <dt>热门场馆<span class="arrow"></span></dt>
                    <dd id="sitehotVenue"></dd>
                </dl>
            </div>

            <div class="item show-category">
                <ul class="tab clear" id="categoryTitle"></ul>
                <div class="detail">
                    <div class="on">
        ...
        <div class="order">
            <a name="tuijianArtistVenue" id="tuijianArtistVenue"></a>
            <ul class="tab">
                <li><a class="first active" href="javascript:;">艺人</a></li>
                <li><a href="javascript:;">场馆</a></li>
            </ul>
            <div class="detail">
                <div class="con on">
                    <ul class="add" itype="2" id="artistlist"></ul>
                    <a class="change" id="changeartist" href="javascript:;" pageindex="1" style="display:none">换一组</a>
                </div>

                <div class="con">
                    <ul class="add" itype="3" id="veunelist"></ul>
                    <a class="change" id="changevenue" href="javascript:;" pageindex="1" style="display:none">换一组</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="floor drama" id="drama">
        ...
        <div class="box">
            ...
            <div class="mid">
                <ul class="list clear">
                    <li>
						<span class="img"><a href="https://piao.damai.cn/143863.html" target="_blank" id="home_xjdr_pic_001_143863">
                            <img original="https://pimg.dmcdn.cn/perform/project/1438/143863_n.jpg?_t=1519460175292" alt="“快乐在路上”2018至乐汇《驴得水Mr. Donkey》荒诞戏剧深圳站" width="112" height="150" title="“快乐在路上”2018至乐汇《驴得水Mr. Donkey》荒诞戏剧深圳站"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/143863.html" target="_blank" title="“快乐在路上”2018至乐汇《驴得水Mr. Donkey》荒诞戏剧深圳站" id="home_xjdr_pic_001_143863">“快乐在路上”2018至乐汇《驴得水Mr. Donkey》荒诞戏...</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                                <strong class="num scorenum" pid="143863">8.0</strong>
                            </dd>
                            <dd class="txt">
                    ...
                    <li>
						<span class="img"><a href="https://piao.damai.cn/143533.html" target="_blank" id="home_xjdr_pic_002_143533">
                        ...
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/143533.html" target="_blank" title="MaiLive 廖一梅 孟京辉“悲观主义三部曲”《琥珀》重庆站" id="home_xjdr_pic_002_143533">MaiLive 廖一梅 孟京辉“悲观主义三部曲”《琥珀》重...</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                    ...
                    <li>
						<span class="img"><a href="https://piao.damai.cn/143466.html" target="_blank" id="home_xjdr_pic_003_143466">
                        ...
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/143466.html" target="_blank" title="“快乐在路上”2018至乐汇《破阵子 The Ugly Town》荒诞戏剧（广州站）" id="home_xjdr_pic_003_143466">“快乐在路上”2018至乐汇《破阵子 The Ugly Town》荒...</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                ...
                <ul class="comment">
                    <li>
                        <span class="user"><img original="<%=basePath%>/concert/images/Avtars/A27.jpg" alt="" width="30" height="30"></span>
                        <div class="talk"><span class="name" title="麦子">麦子</span>评论了：<a href="https://piao.damai.cn/116269.html" target="_blank" title="剧情衔接合理，笑中有泪，演员演技精湛，刻画角色入木三分！来北京看这场话剧太值了" id="home_xjdr_pl_001">剧情衔接合理，笑中有泪，演员演技精湛，刻画角色入木...</a></div>
                    </li>
                    <li>
                        <span class="user"><img original="<%=basePath%>/concert/images/Avtars/A26.jpg" alt="" width="30" height="30"></span>
                        <div class="talk"><span class="name" title="LLLiurh">LLLiurh</span>评论了：<a href="https://piao.damai.cn/137272.html" target="_blank" title="五年前在北京错过了希望今年在上海能看成" id="home_xjdr_pl_002">五年前在北京错过了希望今年在上海能看成</a></div>
                    </li>
                </ul>
            </div>
                            ...
                            <ol class="live">
                                <li>
                                    ...
                                    <div class="works">
                                        ...
                                        <p><a href="https://piao.damai.cn/139754.html" title="《爱在歇斯底里时》" target="_blank" id="home_xjdr_paihang_xiao_001">《爱在歇斯底里时》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        ...
                                        <p><a href="https://piao.damai.cn/144197.html" title="《恋爱的犀牛》" target="_blank" id="home_xjdr_paihang_xiao_002">《恋爱的犀牛》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        ...
                                        <p><a href="https://piao.damai.cn/139821.html" title="《两只狗的生活意见》" target="_blank" id="home_xjdr_paihang_xiao_003">《两只狗的生活意见》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >4</span>
                                        <p><a href="https://piao.damai.cn/139619.html" title="《无人入眠》" target="_blank" id="home_xjdr_paihang_xiao_004">《无人入眠》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >5</span>
                                        <p><a href="https://piao.damai.cn/142725.html" title="《窗前不止明月光》" target="_blank" id="home_xjdr_paihang_xiao_005">《窗前不止明月光》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >6</span>
                                        <p><a href="https://piao.damai.cn/116269.html" title="《那次奋不顾身的爱情》" target="_blank" id="home_xjdr_paihang_xiao_006">《那次奋不顾身的爱情》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >7</span>
                                        <p><a href="https://piao.damai.cn/145684.html" title="《屋顶上的奥菲莉亚》" target="_blank" id="home_xjdr_paihang_xiao_007">《屋顶上的奥菲莉亚》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >8</span>
                                        <p><a href="https://piao.damai.cn/140388.html" title="《臭虫》" target="_blank" id="home_xjdr_paihang_xiao_008">《臭虫》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >9</span>
                                        <p><a href="https://piao.damai.cn/139756.html" title="《一个陌生女人的来信》" target="_blank" id="home_xjdr_paihang_xiao_009">《一个陌生女人的来信》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >10</span>
                                        <p><a href="https://piao.damai.cn/146666.html" title="《死水边的美人鱼》" target="_blank" id="home_xjdr_paihang_xiao_0010">《死水边的美人鱼》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >11</span>
                                        <p><a href="https://piao.damai.cn/131753.html" title="《我是余欢水》" target="_blank" id="home_xjdr_paihang_xiao_0011">《我是余欢水》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >12</span>
                                        <p><a href="https://piao.damai.cn/131753.html" title="《我是余欢水》" target="_blank" id="home_xjdr_paihang_xiao_0012">《我是余欢水》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >13</span>
                                        <p><a href="https://piao.damai.cn/144243.html" title="《巴黎圣母院》" target="_blank" id="home_xjdr_paihang_xiao_0013">《巴黎圣母院》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >14</span>
                                        <p><a href="https://piao.damai.cn/133700.html" title="《谋杀启事》" target="_blank" id="home_xjdr_paihang_xiao_0014">《谋杀启事》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state  up"></strong>
                                    <div class="works">
                                        <span >15</span>
                                        <p><a href="https://piao.damai.cn/144366.html" title="《有多少爱可以胡来》" target="_blank" id="home_xjdr_paihang_xiao_0015">《有多少爱可以胡来》</a></p>
                                    </div>
                                </li>
                            </ol>
                        </div>
                        <div class="con">
                            <ol class="live">
                                <li>
                                    ...
                                    <div class="works">
                                        <span class="top">1</span>
                                        <p><a href="https://piao.damai.cn/146731.html" title="《猫》" target="_blank" id="home_xjdr_paihang_da_001">《猫》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span class="top">2</span>
                                        <p><a href="https://piao.damai.cn/142000.html" title="《莎士比亚别生气》" target="_blank" id="home_xjdr_paihang_da_002">《莎士比亚别生气》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span class="top">3</span>
                                        <p><a href="https://piao.damai.cn/143258.html" title="《爷们儿》" target="_blank" id="home_xjdr_paihang_da_003">《爷们儿》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >4</span>
                                        <p><a href="https://piao.damai.cn/144684.html" title="《最后14堂星期二的课》" target="_blank" id="home_xjdr_paihang_da_004">《最后14堂星期二的课》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >5</span>
                                        <p><a href="https://piao.damai.cn/143270.html" title="《西哈游记》" target="_blank" id="home_xjdr_paihang_da_005">《西哈游记》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >6</span>
                                        <p><a href="https://piao.damai.cn/146524.html" title="《新月饭店》" target="_blank" id="home_xjdr_paihang_da_006">《新月饭店》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >7</span>
                                        <p><a href="https://piao.damai.cn/144479.html" title="《水中之书》" target="_blank" id="home_xjdr_paihang_da_007">《水中之书》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >8</span>
                                        <p><a href="https://piao.damai.cn/143913.html" title="《李茶的姑妈》" target="_blank" id="home_xjdr_paihang_da_008">《李茶的姑妈》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >9</span>
                                        <p><a href="https://piao.damai.cn/141945.html" title="《牢友记》" target="_blank" id="home_xjdr_paihang_da_009">《牢友记》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >10</span>
                                        <p><a href="https://piao.damai.cn/141926.html" title="《二维码杀手》" target="_blank" id="home_xjdr_paihang_da_0010">《二维码杀手》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >11</span>
                                        <p><a href="https://piao.damai.cn/144792.html" title="《乌龙山伯爵》" target="_blank" id="home_xjdr_paihang_da_0011">《乌龙山伯爵》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >12</span>
                                        <p><a href="https://piao.damai.cn/146784.html" title="《战马》" target="_blank" id="home_xjdr_paihang_da_0012">《战马》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >13</span>
                                        <p><a href="https://piao.damai.cn/141698.html" title="《四世同堂》" target="_blank" id="home_xjdr_paihang_da_0013">《四世同堂》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >14</span>
                                        <p><a href="https://piao.damai.cn/140648.html" title="《三体》" target="_blank" id="home_xjdr_paihang_da_0014">《三体》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="state up"></strong>
                                    <div class="works">
                                        <span >15</span>
                                        <p><a href="https://piao.damai.cn/144345.html146557" title="《飞越疯人院》" target="_blank" id="home_xjdr_paihang_da_0015">《飞越疯人院》</a></p>
                                    </div>
                                </li>
                            </ol>
                        </div>
    ...
    <div class="floor sport" id="sport">
        ...
        <div class="box">
            <div class="left">
                <div class="import">
                    <a href="https://piao.damai.cn/146554.html" target="_blank" id="home_tyss_pic_001"><img original="https://pimg.dmcdn.cn/perform/damai/home/201804/20180411135655825.jpg" title="2018超级企鹅足球名人赛" alt="" width="238" height="362"></a>
                    <div class="txt">
                        <p class="name">2018超级企鹅足球名人赛</p>
                        <p class="price"><strong>180</strong>元起</p>
                    </div>
                    <span class="border"></span>
                </div>
            ...
            <div class="mid">
                <ul class="list list2 clear">
                    ...
                    <li class="under">
                        <span class="img"><a href="//piao.damai.cn/146525.html" target="_blank" id="home_tyss_pic_003_146525"><img original="https://pimg.dmcdn.cn/perform/project/1465/146525_n.jpg?_t=1522205156448" alt="" width="112" height="150" title="2018中国足球协会超级联赛 贵州恒丰主场 季票卡">2018中国足球协会超级联赛 贵州恒丰主场 季票卡</a></span>
                        <dl class="infor">
                            <dt><a href="//piao.damai.cn/146525.html" target="_blank" title="2018中国足球协会超级联赛 贵州恒丰主场 季票卡" id="home_tyss_pic_003_146525">2018中国足球协会超级联赛 贵州恒丰主场 季票卡</a></dt>
                            <dd class="txt">
                                <p class="time" title="2018.04.08-05.12">2018.04.08-05.12</p>
                                <p class="place">
                                    <a href="//venue.damai.cn/venue_54163.html" target="_blank" title="金阳奥体中心">金阳奥体中心</a>
                                </p>
                                <p class="price">
                    ...
                    <li class="under">
                        <span class="img"><a href="//piao.damai.cn/144529.html" target="_blank" id="home_tyss_pic_004_144529"><img original="https://pimg.dmcdn.cn/perform/project/1445/144529_n.jpg?_t=1520303572434" alt="" width="112" height="150" title="2018赛季中超联赛山东鲁能主场赛事（单场票）">2018赛季中超联赛山东鲁能主场赛事（单场票）</a></span>
                        <dl class="infor">
                            <dt><a href="//piao.damai.cn/144529.html" target="_blank" title="2018赛季中超联赛山东鲁能主场赛事（单场票）" id="home_tyss_pic_004_144529">2018赛季中超联赛山东鲁能主场赛事（单场票）</a></dt>
                            <dd class="txt">
                                <p class="time" title="2018.03.04-04.14">2018.03.04-04.14</p>
                                <p class="place">
                                    <a href="//venue.damai.cn/venue_53104.html" target="_blank" title="济南奥体中心体育场">济南奥体中心体育场</a>
                                </p>
                                <p class="price">
                                    ￥<strong>60</strong>起								</p>
                            </dd>
                        </dl>
                    </li>
                </ul>
                        ...
                        <div class="con">
                            <ol class="live">
                                <li>
                                    ...
                                    <div class="works">
                                        <span class="top">1</span>
                                        <p><a href="https://piao.damai.cn/146062.html" target="_blank" title="The Color Run™ 北京站(14:30下午场）" id="home_tyss_paihang_001">The Color Run™ 北京站(14:30下午场）</a></p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="works">
                                        <span class="top">2</span>
                                        <p><a href="https://piao.damai.cn/143763.html" target="_blank" title="2018中国足球协会超级联赛 贵州恒丰主场 单场票" id="home_tyss_paihang_002">2018中国足球协会超级联赛 贵州恒丰主场 单场票</a></p>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="works">
                                        <span >5</span>
                                        <p><a href="https://piao.damai.cn/138727.html" target="_blank" title="2018 FORMULA1 中国大奖赛" id="home_tyss_paihang_005">2018 FORMULA1 中国大奖赛</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">上海</strong>
                                ...
                                <li>
                                    ...
                                    <div class="works">
                                        <span >7</span>
                                        <p><a href="https://piao.damai.cn/142364.html" target="_blank" title="2018赛季中甲联赛青岛黄海制药足球俱乐部全年套票（年卡）" id="home_tyss_paihang_007">2018赛季中甲联赛青岛黄海制药足球俱乐部全年套票（年卡）</a></p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="works">
                                        <span >8</span>
                                        <p><a href="https://piao.damai.cn/143411.html" target="_blank" title="2018赛季中甲联赛 深圳佳兆业主场套票" id="home_tyss_paihang_008">2018赛季中甲联赛 深圳佳兆业主场套票</a></p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="works">
                                        <span >9</span>
                                        <p><a href="https://piao.damai.cn/145336.html" target="_blank" title="The Color Run™沈阳站" id="home_tyss_paihang_009">The Color Run™沈阳站</a></p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="works">
                                        <span >10</span>
                                        <p><a href="https://piao.damai.cn/145697.html" target="_blank" title="2018营山国际马拉松赛" id="home_tyss_paihang_0010">2018营山国际马拉松赛</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">成都</strong>
                                    <div class="works">
                                        <span >11</span>
                                        <p><a href="https://piao.damai.cn/144949.html" target="_blank" title="The Color Run™ 成都站" id="home_tyss_paihang_0011">The Color Run™ 成都站</a></p>
                                    </div>
                                </li>
                            </ol>
                        </div>
    ...
    <div class="floor music" id="music">
        ...
        <div class="box">
            ...
            <div class="mid">
                <ul class="list clear">
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/142264.html" target="_blank" id="home_gdyy_pic_001_142264"><img original="https://pimg.dmcdn.cn/perform/project/1422/142264_n.jpg?_t=1520396584821" alt="" width="112" height="150" title="爱乐汇·西班牙塞维利亚传统经典弗拉门戈舞剧《卡门》"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/142264.html" target="_blank" title="爱乐汇·西班牙塞维利亚传统经典弗拉门戈舞剧《卡门》" id="home_gdyy_pic_001_142264">爱乐汇·西班牙塞维利亚传统经典弗拉门戈舞剧《卡门》</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                                <strong class="num scorenum" pid="142264">8.0</strong>
                            </dd>
                            <dd class="txt">
                                <p class="time" title="2018.04.28 20:00">2018.04.28 20:00</p>
                                <p class="place">
                                    <a href="//venue.damai.cn/venue_270.html" target="_blank" title="深圳市少年宫剧场">深圳市少年宫剧场</a>
                                </p>
                                <p class="price">
                    ...
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/145203.html" target="_blank" id="home_gdyy_pic_002_145203"><img original="https://pimg.dmcdn.cn/perform/project/1452/145203_n.jpg?_t=1520845524199" alt="" width="112" height="150" title="爱乐汇• “致•爱丽丝”经典浪漫钢琴名曲音乐会"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/145203.html" target="_blank" title="爱乐汇• “致•爱丽丝”经典浪漫钢琴名曲音乐会" id="home_gdyy_pic_002_145203">爱乐汇• “致•爱丽丝”经典浪漫钢琴名曲音乐会</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                    ...
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/144467.html" target="_blank" id="home_gdyy_pic_003_144467"><img original="https://pimg.dmcdn.cn/perform/project/1444/144467_n.jpg?_t=1519979939063" alt="" width="112" height="150" title="爱乐汇•俄罗斯芭蕾国家剧院芭蕾舞《胡桃夹子》"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/144467.html" target="_blank" title="爱乐汇•俄罗斯芭蕾国家剧院芭蕾舞《胡桃夹子》" id="home_gdyy_pic_003_144467">爱乐汇•俄罗斯芭蕾国家剧院芭蕾舞《胡桃夹子》</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                    ...
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/143519.html" target="_blank" id="home_gdyy_pic_004_143519"><img original="https://pimg.dmcdn.cn/perform/project/1435/143519_n.jpg?_t=1518506544900" alt="" width="112" height="150" title="爱乐汇·《夜的钢琴曲》——石进钢琴作品音乐会"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/143519.html" target="_blank" title="爱乐汇·《夜的钢琴曲》——石进钢琴作品音乐会" id="home_gdyy_pic_004_143519">爱乐汇·《夜的钢琴曲》——石进钢琴作品音乐会</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                ...
                <ul class="comment">
                    <li>
                        <span class="user"><img original="<%=basePath%>/concert/images/Avtars/A15.jpg" alt="" width="30" height="30"></span>
                        <div class="talk"><span class="name" title="tyyldm">tyyldm</span>评论了：<a id="home_gdyy_pl_001" href="https://piao.damai.cn/141105.html" target="_blank" title="can not wait!!!">can not wait!!!</a></div>
                    </li>
                    <li>
                        <span class="user"><img original="<%=basePath%>/concert/images/Avtars/A14.jpg" alt="" width="30" height="30"></span>
                        <div class="talk"><span class="name" title="晨">晨</span>评论了：<a id="home_gdyy_pl_002" href="https://piao.damai.cn/140030.html" target="_blank" title="想去看想去看！超级想看他的手指，疯一般的迷恋">想去看想去看！超级想看他的手指，疯一般的迷恋</a></div>
                    </li>
                </ul>
            </div>
            <div class="right">
                <div class="rank">
                    ...
                    <div class="detail">
                        <div class="con">
                            <ol class="live">
                                <li>
                                    <strong class="txt">广州</strong>
                                    <div class="works">
                                        <span class="top">1</span>
                                        <p><a href="https://piao.damai.cn/145492.html?spm=a2o6e.search.0.0.19d04d15mRBJtV" target="_blank" title="“好戏100大惠演”舞剧《本初》" id="home_gdyy_paihang_001">“好戏100大惠演”舞剧《本初》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">广州</strong>
                                    <div class="works">
                                        <span class="top">2</span>
                                        <p><a href="https://piao.damai.cn/146908.html?spm=a2o6e.search.0.0.19d04d15mRBJtV" target="_blank" title="江苏艺术基金2016年度资助项目 民族芭蕾舞剧《西施》" id="home_gdyy_paihang_002">江苏艺术基金2016年度资助项目 民族芭蕾舞剧《西施》</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">深圳</strong>
                                    <div class="works">
                                        <span class="top">3</span>
                                        <p><a href="https://piao.damai.cn/142260.html?spm=a2o6e.search.0.0.19d04d15mRBJtV" target="_blank" title="迈克尔·弗莱利《王者之舞·危险游戏》深圳站" id="home_gdyy_paihang_003">迈克尔·弗莱利《王者之舞·危险游戏》深圳站</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">深圳</strong>
                                    <div class="works">
                                        <span >4</span>
                                        <p><a href="https://piao.damai.cn/143667.html?spm=a2o6e.search.0.0.45574d15B2RtlP" target="_blank" title="爱乐汇·柏林爱乐钢琴家金·芭比儿童钢琴启蒙音乐会" id="home_gdyy_paihang_004">爱乐汇·柏林爱乐钢琴家金·芭比儿童钢琴启蒙音乐会</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">深圳</strong>
                                    <div class="works">
                                        <span >5</span>
                                        <p><a href="https://piao.damai.cn/143675.html?spm=a2o6e.search.0.0.45574d15B2RtlP" target="_blank" title="爱乐汇·台湾钢琴诗人Pianoboy高至豪流行钢琴深圳音乐会" id="home_gdyy_paihang_005">爱乐汇·台湾钢琴诗人Pianoboy高至豪流行钢琴深圳音乐会</a></p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="works">
                                        <span >6</span>
                                        <p><a href="https://piao.damai.cn/140794.html?spm=a2o6e.search.0.0.488dc62dLYAcN7" target="_blank" title="《荷兰康科迪亚弦乐四重奏》音乐会" id="home_gdyy_paihang_006">《荷兰康科迪亚弦乐四重奏》音乐会</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">上海</strong>
                                    <div class="works">
                                        <span >7</span>
                                        <p><a href="https://piao.damai.cn/140719.html?spm=a2o6e.search.0.0.5b64df08IPSMov" target="_blank" title="欧罗巴的迷雾（三）：马勒的【复活】" id="home_gdyy_paihang_007">欧罗巴的迷雾（三）：马勒的【复活】</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">上海</strong>
                                    <div class="works">
                                        <span >8</span>
                                        <p><a href="https://piao.damai.cn/140721.html?spm=a2o6e.search.0.0.5b64df08IPSMov" target="_blank" title="恬静年代：库普曼 阿姆斯特丹巴洛克合唱团与SSO演绎海顿《四季》" id="home_gdyy_paihang_008">恬静年代：库普曼 阿姆斯特丹巴洛克合唱团与SSO演绎海顿《四季》</a></p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="works">
                                        <span >9</span>
                                        <p><a href="https://piao.damai.cn/140736.html?spm=a2o6e.search.0.0.5b64df08IPSMov" target="_blank" title="“海上钢琴师”电影原声音乐演奏家—吉达·布塔钢琴视听音乐会·杭州站" id="home_gdyy_paihang_009">“海上钢琴师”电影原声音乐演奏家—吉达·布塔钢琴视听音乐会·杭州站</a></p>
                                    </div>
                                </li>
                                <li>
                                    <strong class="txt">上海</strong>
                                    <div class="works">
                                        <span >10</span>
                                        <p><a href="https://piao.damai.cn/136512.html?spm=a2o6e.search.0.0.344ee31cTR5kWQ" target="_blank" title="上海歌舞团2018舞剧·舞蹈演出季：舞剧《朱鹮》" id="home_gdyy_paihang_0010">上海歌舞团2018舞剧·舞蹈演出季：舞剧《朱鹮》</a></p>
                                    </div>
                                </li>
                            </ol>
                        </div>
    ...
    <div class="floor kid" id="kid">
        ...
        <div class="box">
            ...
            <div class="mid">
                <ul class="list clear">
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/145045.html" target="_blank" id="home_etqz_pic_001_145045"><img title="亲子剧《三只小猫》（北京文化艺术基金2017年度资助项目）" original="https://pimg.dmcdn.cn/perform/project/1450/145045_n.jpg?_t=1521622166799" alt="" width="112" height="150"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/145045.html" id="home_etqz_pic_001_145045" target="_blank" title="亲子剧《三只小猫》（北京文化艺术基金2017年度资助项目）">亲子剧《三只小猫》（北京文化艺术基金2017年度资助项...</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                                <strong class="num scorenum" pid="145045">8.0</strong>
                            </dd>
                            <dd class="txt">
                                <p class="time" title="2018.06.16-06.24">2018.06.16-06.24</p>
                                <p class="place">
                                    <a href="//venue.damai.cn/venue_60614.html" target="_blank" title="大麦·超剧场">大麦·超剧场</a>
                                </p>
                                <p class="price">
                    ...
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/140348.html" target="_blank" id="home_etqz_pic_002_140348"><img title="纽伯瑞 凯迪克大奖绘本同名儿童剧《市场街最后一站》" original="https://pimg.dmcdn.cn/perform/project/1403/140348_n.jpg" alt="" width="112" height="150"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/140348.html" id="home_etqz_pic_002_140348" target="_blank" title="纽伯瑞 凯迪克大奖绘本同名儿童剧《市场街最后一站》">纽伯瑞 凯迪克大奖绘本同名儿童剧《市场街最后一站》</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                                <strong class="num scorenum" pid="140348">8.0</strong>
                            </dd>
                            <dd class="txt">
                                <p class="time" title="2018.06.23-06.24">2018.06.23-06.24</p>
                                <p class="place">
                                    <a href="//venue.damai.cn/venue_42.html" target="_blank" title="京演民族宫大剧院">京演民族宫大剧院</a>
                                </p>
                                <p class="price">
                                    ￥<strong>100</strong>起								</p>
                            </dd>
                        </dl>
                    </li>
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/121104.html" target="_blank" id="home_etqz_pic_003_121104"><img title="“哆唻咪和大灰鸡”亲子故事音乐会——《妈妈爱我》" original="https://pimg.dmcdn.cn/perform/project/1211/121104_n.jpg" alt="" width="112" height="150"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/121104.html" id="home_etqz_pic_003_121104" target="_blank" title="“哆唻咪和大灰鸡”亲子故事音乐会——《妈妈爱我》">“哆唻咪和大灰鸡”亲子故事音乐会——《妈妈爱我》</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
                                <strong class="num scorenum" pid="121104">8.0</strong>
                            </dd>
                            <dd class="txt">
                                <p class="time" title="2018.05.13">2018.05.13</p>
                                <p class="place">
                    ...
                    <li>
                        <span class="img"><a href="https://piao.damai.cn/144825.html" target="_blank" id="home_etqz_pic_004_144825"><img title="小动物嘉年华之《丽莎的梦幻世界》" original="https://pimg.dmcdn.cn/perform/project/1448/144825_n.jpg?_t=1520919766383" alt="" width="112" height="150"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="https://piao.damai.cn/144825.html" id="home_etqz_pic_004_144825" target="_blank" title="小动物嘉年华之《丽莎的梦幻世界》">小动物嘉年华之《丽莎的梦幻世界》</a>
                            </dt>
                            <dd class="score">
                                <span class="star"><b style="width:80%;"></b></span>
    ...
    <div class="floor rock" id="rock">
        ...
        <div class="box">
            ...
            <div class="mid">
                <ul class="list list2 clear">
                    <li >
                        <span class="img"><a href="https://piao.damai.cn/145427.html" target="_blank" id="home_ygzls_pic_001_145427"><img original="https://pimg.dmcdn.cn/perform/project/1454/145427_n.jpg?_t=1521005580156" title="2018珠江源爨星音乐节" alt="" width="112" height="150"></a></span>
                        <dl class="infor">
                            <dt>
                                <a href="//piao.damai.cn/145427.html" target="_blank" title="2018珠江源爨星音乐节" id="home_ygzls_pic_001_145427">2018珠江源爨星音乐节</a>
                            </dt>
                            <dd class="txt">
                                <p class="time" title="2018.05.05—05.06">2018.05.05—05.06</p>
                                <p class="place">
                                    <a href="//venue.damai.cn/venue_60949.html" target="_blank" title="云南沾益珠江源风景区">云南沾益珠江源风景区</a>
                                </p>
                                <p class="price">
                                    ￥<strong>199</strong>起								</p>
                            </dd>
                        </dl>
                    </li>
                    <li >
...
<img style="cursor:pointer;cursor:hand" src="<%=basePath%>/concert/picture/siteseal_gd_3_h_l_m.gif" onclick="verifySeal();" alt="SSL site seal - click to verify">		</span>
    ...
    <!--返回顶部 start-->
    <div class="side-sort">
        <div class="side-sort-hd">
            <div class="on-service">
                <strong class="sort-online-service xnchatService">在线<br>客服</strong>
            </div>
            <a href="//m.damai.cn/download.html" class="sort-i1" target="_blank">
                <i></i>
                <strong class="sort-name">大麦</strong>
				<span class="s-ewm">
					<img src="<%=basePath%>/concert/picture/kehuduan.png">
						<span class="f14">比PC更迅猛</span><br><span>提前开抢</span>
						</span>
            </a>
        </div>
...
<script type="text/javascript" src="<%=basePath%>/concert/js/index-min.js"></script>
<script type="text/javascript" src="<%=basePath%>/concert/js/public-min.js"></script>
<script type="text/javascript">var pageId = 1;</script>
<script type="text/javascript" src="<%=basePath%>/concert/js/localindex.js"></script>
...
<script type="text/javascript" src="<%=basePath%>/concert/js/mailang.js"></script>
<script type="text/javascript">
